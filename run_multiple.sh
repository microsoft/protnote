...
python train.py --name 'base_run_t1' --override TEMPERATURE 1 --use-wandb
python train.py --name 'base_run_t2' --override TEMPERATURE 0.5 --use-wandb
...
python train.py --name 'let_label_embedding_train_t1_batch_labels_only' --override TEMPERATURE 0.5 USE_BATCH_LABELS_ONLY True --use-wandb
python train.py --name 'let_label_embedding_train_t1_batch_labels_only' --override TEMPERATURE 0.05 USE_BATCH_LABELS_ONLY True --use-wandb
python train.py --name 'let_label_embedding_train_t1_batch_labels_only' --override TEMPERATURE 0.01 USE_BATCH_LABELS_ONLY True --use-wandb
...
python train.py --name 'base_run_batch_labels_only' USE_BATCH_LABELS_ONLY True --use-wandb
