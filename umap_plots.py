...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default="outputs/results/umap_figs/",
    ...
    embeddings = torch.load(
        "outputs/results/test_1_embeddings_TEST_TOP_LABELS_DATA_PATH_normal_test_label_aug_v4/batches_0_99.pt",
        map_location="cpu",
    )
    joint_embedding_dim = embeddings["joint_embeddings"].shape[-1]
    num_labels = embeddings["labels"].shape[-1]
    vocab = generate_vocabularies(
