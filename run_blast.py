...
def main():
    ...
    raw_results_output_path = os.path.join(
        args.output_dir, f"blast_raw_{test_name}_{train_name}_results.tsv"
    )
    parsed_results_output_path = os.path.join(
        args.output_dir, f"blast_parsed_{test_name}_{train_name}_results.parquet"
    )
    pivot_parsed_results_output_path = os.path.join(
        args.output_dir, f"blast_pivot_parsed_{test_name}_{train_name}_results.parquet"
    )
