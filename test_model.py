...
def main():
    ...
    UPDATED_TEST_COMMANDS = {k:v.replace(MODEL_PATH_TOKEN,args.model_path).replace(MODEL_NAME_TOKEN,model_name) for k,v in TEST_COMMANDS.items()}
