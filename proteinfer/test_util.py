...
def assert_dataframes_equal(
    ...
    for actual_record, expected_record in zip(actual_records, expected_records):
        abseil_testcase_instance.assertCountEqual(
            actual_record.keys(), expected_record.keys(), potential_error_message
        )
            ...
            if isinstance(actual_value, np.ndarray):
                ...
                if (
                    ...
                    raise AssertionError(
                        ...
                        "{} != {}. {}".format(
                            actual_value, expected_value, potential_error_message
                        ),
                    )
            else:
                abseil_testcase_instance.assertEqual(
