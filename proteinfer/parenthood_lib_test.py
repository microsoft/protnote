...
class ParenthoodLibTest(parameterized.TestCase):
    def setUp(self):
        self._data_path = path.join(FLAGS.test_srcdir, "./testdata")
        super().setUp()
    ...
    @parameterized.named_parameters(
        ...
        dict(
            ...
            expected=parenthood_lib.GoTerm(
                ...
                term_name=None,
                description=None,
                related_labels={("is_a", "GO:0048308"), ("is_a", "GO:0048311")},
            ),
        ),
        dict(
    ...
    def test_go_term_parsing_integration_test(self):
        gene_ontology_reference_full_file_path = path.join(self._data_path, "go.obo")
        ...
        is_obsolete = lambda term: any(
            l[0] == "replaced_by" for l in term.related_labels
        )
    ...
    def test_transitive_go_parenthood(self):
        ...
        child2 = parenthood_lib.GoTerm(
            term_id="child2", term_name=None, description=None, related_labels=set()
        )
    ...
    def test_parse_full_ec_file_to_transitive_parenthood_integration_test(self):
        ...
        with tf.io.gfile.GFile(enzyme_commission_reference_class_full_file_path) as f:
    ...
    def test_ec_label_to_description(self):
        ...
        actual = parenthood_lib.ec_label_to_description(
            whole_ec_dat_contents, whole_ec_class_contents
        )
    ...
    @parameterized.named_parameters(
        ...
        dict(
            ...
            input_go_term=parenthood_lib.GoTerm(
                ...
                term_name=None,
                description=None,
                related_labels={("replaced_by", "replacement"), ("is_a", "parent")},
            ),
            expected=[
                # Should be a no-op.
                parenthood_lib.GoTerm(
                    ...
                    term_name=None,
                    description=None,
                    related_labels={("is_a", "parent"), ("replaced_by", "replacement")},
                ),
            ],
        ),
        dict(
            ...
            expected=[
                parenthood_lib.GoTerm(
                    ...
                    description=None,
                    related_labels={
                        (parenthood_lib._IS_NON_CANONICAL_ALT_ID_LABEL_OF, "child")
                    },
                ),
                parenthood_lib.GoTerm(
                    term_id="child",
