...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="data/swissprot/proteinfer_splits/random/train_GO.fasta",
    )
    parser.add_argument(
        "--val_path",
        required=False,
        help="Path to the validation set fasta file.",
        default="data/swissprot/proteinfer_splits/random/dev_GO.fasta",
    )
    parser.add_argument(
        "--test_path",
        required=False,
        help="Path to the test set fasta file.",
        default="data/swissprot/proteinfer_splits/random/test_GO.fasta",
    )
    parser.add_argument(
        "--label_vocab_path",
        required=False,
        help="Path to the label vocabulary JSON file.",
        default="data/vocabularies/proteinfer/GO_label_vocab.json",
    )
    parser.add_argument(
        "--output_path",
        required=False,
        help="Directory where the filtered fasta files will be saved.",
        default="data/swissprot/proteinfer_splits/random/",
    )
